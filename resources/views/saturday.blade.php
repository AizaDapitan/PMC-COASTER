...
@if($displayMain)
  <div class="container" id="maincontent" style="width: 1440px!important;">
    <ul class="blog-info">
        ...
        <li><i class="fa fa-calendar"></i> {{ $satSchedString->toFormattedDateString() }} ({{ $satSched->travel_day }})</li>
        <li><i class="fa fa-history"></i> 12:30 PM</li>
        <li><i class="fa fa-tags"></i> Agusan To Davao</li>
        <li> &nbsp;</li>
        <li> &nbsp;</li>
        <li>
          <h3>Legend:</h3>
...
@section('pagejs')
    ...
    <script type="text/javascript">
      ...
      function searchbooking(a) {
        $.ajax({
            method: "GET",
            url: "{{ env('APP_URL')}}/ajax?act=searchbooking",
            data: {
              pword: a
            }
          })
        ...
        if (adx >= 1) {
          bootbox.dialog({
            ...
            message: '<div class="row">  ' +
              '<div class="col-md-12"> ' +
              // '<form class="form-horizontal" id="frmsatfinal" method="post" action="/saturday"> ' +
          ...
          bootbox.dialog({
            ...
            message: '<div class="row">  ' +
              '<div class="col-md-12"> ' +
              // '<form class="form-horizontal" id="frmsatfinal" method="post" action="' + appurl + '"/saturday"> ' +
              '<form class="form-horizontal" id="frmsatfinal" method="post" action="'+ document.URL +'"> ' +
                '<input name="_token" value="' + f + '" type="hidden"> ' +
              ' <div class="form-body"> <input type="hidden" name="destination" value="' + b + '"> <input type="hidden" name="sit" value="' + c + '">  <input type="hidden" name="employee" value="' + a + '"> ' +
              '   <div class="form-group">' +
